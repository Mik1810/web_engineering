...
<head>
    ...
    <link rel="stylesheet" href="/style/gestione-tecnici-preventivi.css">
...
<div class="container">
    <h1>Gestisci Tecnici Preventivi</h1>
...
<script type="module" src="/scripts/gestione_tecnici_preventivi.js"></script>
<!--
