...
<div class="container">
    <div id="left-content" class="left-content">
        <div id="categoriePadreSelect" class="d-flex flex-column mb-2">
            ...
            <select name="sceltaCategoriaPadre" id="sceltaCategoriaPadre" class="form-select select-size"
                    aria-label="Select per categoria padre">
        ...
        <div id="categorieFiglioSelect" class="d-flex flex-column invisible mb-2">
            ...
            <select name="sceltaCategoriaFiglio" id="sceltaCategoriaFiglio" class="form-select select-size"
                    aria-label="Select per categoria figlio">
            </select>
        </div>
        ...
        <div id="categorieNipoteSelect" class="d-flex flex-column invisible mb-2">
            ...
            <select name="sceltaCategoriaNipote" id="sceltaCategoriaNipote" class="form-select select-size"
                    aria-label="Select per categoria nipote">
            </select>
        </div>
    </div>
