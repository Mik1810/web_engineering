...
<head>
    ...
    <title>Gestisci Ordinanti</title>
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.0.0/dist/css/bootstrap.min.css"
          integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <link rel="stylesheet" href="/style/gestione-ordinanti.css">
    ...
    <div class="row">
        ...
        <div class="list">
            ...
            <table class="table">
                ...
                <tbody id="tbody">
                <#list ordinanti as ordinante>
                    <tr>
                        <td>${ordinante.email}</td>
                        <td><a href="gestione_uffici?id_ufficio=${ordinante.ufficio.key}">${ordinante.ufficio.citta}
                                , ${ordinante.ufficio.sede}</td>
                        <td>
                            <form method="POST" action="gestione_ordinanti?page=${page}">
                                <input type="hidden" name="id" value="${ordinante.key}">
...
<script type="module" src="/scripts/gestione_ordinanti.js"></script>
<!--
