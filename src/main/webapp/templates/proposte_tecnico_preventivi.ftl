                ...
                <ul class="pagination">
                    ...
                    <#else>
                        <li class="page-item"><a class="btn btn-primary"
                                                 href="proposte_tecnico_preventivi?page=${page-1}">Pagina precedente</a>
                        </li>
                    </#if>
                    <li class="page-item"><a class="btn btn-primary" href="proposte_tecnico_preventivi?page=${page+1}">Pagina
                            successiva</a>
                    </li>
                </ul>
            </nav>
